...
const LoginForm = () => {
    ...
    return (
        <form className="w-full flex flex-col justify-center mx-auto" onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} className="w-full py-2 my-2 bg-[#fdd341] text-white rounded-md hover:opacity-95 disabled:opacity-80">{loading ? 'Logging in...' : 'Login'}</button>
            <OAuth />
        </form>
    );
};
